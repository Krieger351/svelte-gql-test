...
export type All_PeopleQueryVariables = Exact<{ [key: string]: never }>;

export type All_PeopleQuery = {
  __typename?: "Root";
  allPeople?: {
    __typename?: "PeopleConnection";
    people?: Array<{
...
export type Get_PersonQueryVariables = Exact<{
  ID: Scalars["ID"]["input"];
}>;

export type Get_PersonQuery = {
  __typename?: "Root";
  person?: {
    __typename?: "Person";
    name?: string | null;
...
export const All_PeopleDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ALL_PEOPLE" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<All_PeopleQuery, All_PeopleQueryVariables>;
export const Get_PersonDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GET_PERSON" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "filmConnection" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
...
} as unknown as DocumentNode<Get_PersonQuery, Get_PersonQueryVariables>;
